...
imagePlateau = pygame.transform.scale(imagePlateau, (fenetrePrincipale.get_size()[0]-imageShop.get_size()[0] if fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]<fenetrePrincipale.get_size()[1] else fenetrePrincipale.get_size()[1]-100,fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]-100 if fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]<fenetrePrincipale.get_size()[1] else fenetrePrincipale.get_size()[1]-100))
...
while garderOuvert == True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.WINDOWRESIZED:
            imageFondForet = pygame.transform.scale(imageFondForet,(fenetrePrincipale.get_size()[0], fenetrePrincipale.get_size()[1]))
            imageShop = pygame.transform.scale(imageShop, (fenetrePrincipale.get_size()[0]/4, fenetrePrincipale.get_size()[1]*0.90))
            imagePlateau = pygame.transform.scale(imagePlateau, (fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]*2 if fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]<fenetrePrincipale.get_size()[1] else fenetrePrincipale.get_size()[1]-100,fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]-100 if fenetrePrincipale.get_size()[0]-imageShop.get_size()[0]<fenetrePrincipale.get_size()[1] else fenetrePrincipale.get_size()[1]-100))
